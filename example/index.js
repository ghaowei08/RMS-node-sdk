...
// Online SDK
const razerOnlineSdk = razerSDK.onlineInstance({ merchantId: 'FMfeedme', verifyKey: '7dfc880f141046a389c03bc82504a781', secretKey: '39673b201e11ec7b07c4b20b61c18b5f', callbackUrl: '' })
// Offline SDK
const razerOfflineSDK = razerSDK.offlineInstance({ storeId: '', applicationCode: '', secretKey: '', terminalId: '' })

async function main() {
  try {
    const a = await razerOnlineSdk.getSettlements({ data: new Date('2023-06-12') })
    ...
    // await razerOnlineSdk.checkRefundStatusByOrderId({ orderId: '6405e2989dd8245f6f7248e7' })
    // // Request Refund
    // await razerOnlineSdk.requestRefund({ orderId: 'ORDER123', transactionId: "TRANSACTION123", amount: '5.00' })
    // // Read Settlement
    // await razerOnlineSdk.getSettlements({ data: new Date('2023-03-17') })
